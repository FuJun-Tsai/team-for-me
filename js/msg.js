...
function showMsgbox() {
    ...
    // 	msgbox.firstElementChild.innerHTML = "偷税漏税被抓，关押" + person.stop + "天";
    // }
    ...
    // 	msgbox.firstElementChild.innerHTML = "你花费$800搭乘飞机前往英国"
    // }
    // else if(msgtype == "airportwest"){
    // 	msgbox.firstElementChild.innerHTML = "你花费$800搭乘飞机返回中国"
    // }
